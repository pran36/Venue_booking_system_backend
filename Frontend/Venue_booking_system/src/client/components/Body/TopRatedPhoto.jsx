    ...
    <div className="bg-white rounded-xl shadow-lg overflow-hidden transition-transform duration-300 hover:shadow-xl hover:-translate-y-1">
      ...
      <div className="relative h-60">
        ...
        <div 
          ...
          style={{ backgroundImage: `url(${photo.imagePlaceholder})` }}
        >
      ...
      <div className="p-4">
        ...
        <h3 className="text-lg font-bold text-gray-800 mb-3 line-clamp-2">{photo.name}</h3>
...
export function TopRatedPhoto() {
  return (
    <section className="mt-12 max-w-7xl mx-auto">
      {/* Section Header */}
      <div className="flex justify-between items-center mb-6 px-2 md:px-0">
        <h2 className="text-2xl font-bold text-gray-800">Top Rated Photo and Video</h2>
